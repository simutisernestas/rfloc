...
\title{RF-based positioning for Unmanned Autonomous Vehicles} % to reference as \title, dont use \maketitle
...
\input{sources/1_projectgoals.tex}

\newpage

\section{RF-based positioning} \label{ch2}
\input{sources/2_techcomp.tex}

\section{Implementation} \label{ch3}
\input{sources/3_practical.tex}
